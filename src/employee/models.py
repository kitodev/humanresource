...
class Emergency(models.Model):
    ...
    tel = PhoneNumberField(default='+36 20 7354 475', null = False, blank=False, verbose_name='Phone Number (Example +36 20 7354 475)', help_text= 'Enter number with Country Code Eg. +36 20 7354 475')
...
class Relationship(models.Model):
    ...
    tel = PhoneNumberField(default=None, null = True, blank=True, verbose_name='Spouse Phone Number (Example +36 20 7354 475)', help_text= 'Enter number with Country Code Eg. +36 20 7354 475')
    ...
    contact = PhoneNumberField(verbose_name='Next of Kin Phone Number (Example +36 20 7354 475)',null=True,blank=True,help_text='Phone Number of Next of Kin')
