...
def dashboard_employees_create(request):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			# email_message = 'You have been added to Alveolagroup Staff List,username and password'
			# from_email = settings.EMAIL_HOST_USER
			# to_email = [employee_email]
			'''
			Work on it - user@gmail.com & user@Alveolagroup.com -> send Template
			'''
			# send_mail(
			# 	email_subject,
			# 	email_message,
...
# Alveola staffs leaves table user only
